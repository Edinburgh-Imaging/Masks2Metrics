...
prompt = ['Along which direction was the region of interest drawn?\n Please note that this ' ...
    ...
    '\n ''1'' for sagittal (i.e., along the x-axis)'...
...
if(draw) %draw=1
    fprintf(['\n\nWARNING: you have set the value of ''draw'' to 1, so Masks2Metrics',...
          '\n will generate and display 2 figures for each of the %d segments,',...
        '\n for every slice in which these segments appear. ',...
	'\n Please refer to the Wiki for more information on figure content.',...
        '\n\nPress:',...
...
%convert array to type double as make_nii cannot handle logical data
