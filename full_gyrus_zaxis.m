function [start_slice,stop_slice,thickness_wm_gm,thickness_gm_wm,mhd,f,wm_sa,gm_area,filled_roi] = full_gyrus_zaxis(data_bin_gm,data_bin_wm,dim,vox_x,vox_y,step_size,draw)
%This function runs when the region of interest (ROI) drawn in the axial direction, i.e. along the z-axis
%
% Inputs:
