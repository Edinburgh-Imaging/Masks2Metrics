...
%
% Function downloaded from Matlab Central 
% https://uk.mathworks.com/matlabcentral/fileexchange/4294-minimum-distance-calculations-between-2-groups-of-pixels?focused=5055089&tab=function
% Last line modified by S. Mikhael- 13.05.16
...
%original code is next line:
%distance = sqrt((Coord1(:,1)-Coord2(:,1)).^2 + (Coord1(:,2)-Coord2(:,2)).^2);
%Replacing original code by next line to represent outer edge to outer edge distance
Coord1=double(Coord1); Coord2=double(Coord2);
distance = sqrt((Coord1(:,1)-Coord2(:,1)+1).^2 + (Coord1(:,2)-Coord2(:,2)+1).^2);
