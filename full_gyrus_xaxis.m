function [start_slice,stop_slice,thickness_wm_gm,thickness_gm_wm,mhd,f,wm_sa,gm_area,filled_roi] = full_gyrus_xaxis(data_bin_gm,data_bin_wm,dim,vox_x,vox_y,step_size,draw)
%This function runs when the region of interest (ROI) drawn in the saggital direction, i.e. along the x-axis
% Inputs:
%   data_bin_gm: a binarized version of the gm data
%   data_bin_wm: a binarized version of the wm data
%   dim: dimensions of the image
%   vox_x, vox_y: voxel size along the horizontal (x) and vertical (y) axes
...
%   wm_sa:white matter surface area of a given ROI segment, in Euclidean
%   space (units: mm^2)
